...
class IGService:
    ...
    def fetch_historical_prices_by_epic_and_date_range(self, epic, resolution, start_date, end_date):
        ...
        # response = requests.get('https://api.ig.com/gateway/deal/prices/CS.D.USDJPY.TODAY.IP?resolution=HOUR&from=2023-11-23T08&to=2023-11-24T09&max=20&pageSize=1&pageNumber=1')
